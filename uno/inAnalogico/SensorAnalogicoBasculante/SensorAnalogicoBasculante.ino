...
Experimento:
  ...
  En posición vertical (burbuja abajo) -> la corriente que pasa es de 0.0 voltios
  En posición invertida (burbuja arriba) -> la corriente que pasa es cercana a 5.0 voltios
